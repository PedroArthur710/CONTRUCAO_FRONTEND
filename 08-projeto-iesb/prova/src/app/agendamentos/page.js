...
export default function AgendamentoPage(props) {

  const router = useRouter()

  // Recupera listas do localStorage (substitua pelos nomes específicos)
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Row className='mb-2'>
              ...
              <Form.Group as={Col}>
                ...
                >
                  <option value=''>Selecione</option>
                  {servicos.map(servico => <option key={servico.id} value={servico.nome}>{servico.nome}</option>)}
                </Form.Select>
            ...
            <Row className='mb-2'>
              <Form.Group as={Col}>
                ...
                >
                  <option value=''>Selecione</option>
                  {funcionarios.map(funcionario => <option key={funcionario.id} value={funcionario.nome}>{funcionario.nome}</option>)}
                </Form.Select>
